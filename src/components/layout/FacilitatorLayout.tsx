...
export function FacilitatorLayout({ 
  ...
  return (
    <div id="facilitator-layout" className="min-h-screen bg-slate-50 font-sans text-slate-800">
      {/* MOBILE CONTAINER (lg:hidden) */}
      <div className="lg:hidden min-h-screen bg-slate-50 overflow-x-hidden flex flex-col relative">
        <AppMobileHeader moduleType="facilitator" title="Facilitator Workspace" />
      ...
      <div className="hidden lg:flex min-h-screen bg-slate-50/55 flex-row">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Desktop Header */}
          <header className="flex items-center justify-between h-16 bg-white border-b border-slate-100 px-8 shrink-0">
            {/* Left title & search */}
